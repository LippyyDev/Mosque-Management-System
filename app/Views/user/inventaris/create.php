...
<div class="header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h2 class="page-title">Tambah Inventaris Baru</h2>
...
<div class="card mt-4">
    ...
    <div class="card-body">
        <form action="<?= base_url('user/inventaris/store') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="row">
                <div class="col-md-8">
                    <div class="mb-3">
                        <label for="nama_barang" class="form-label">Nama Barang</label>
                        <input type="text" class="form-control <?= (validation_show_error('nama_barang')) ? 'is-invalid' : '' ?>" id="nama_barang" name="nama_barang" value="<?= old('nama_barang') ?>">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control <?= (validation_show_error('kategori')) ? 'is-invalid' : '' ?>" id="kategori" name="kategori" value="<?= old('kategori') ?>" placeholder="cth: Elektronik, Perabotan, dll.">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control <?= (validation_show_error('jumlah')) ? 'is-invalid' : '' ?>" id="jumlah" name="jumlah" value="<?= old('jumlah') ?>">
                            <div class="invalid-feedback">
                     ...
                     <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control <?= (validation_show_error('tanggal_pembelian')) ? 'is-invalid' : '' ?>" id="tanggal_pembelian" name="tanggal_pembelian" value="<?= old('tanggal_pembelian') ?>">
                             <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                           <label for="kondisi" class="form-label">Kondisi</label>
                            <select class="form-select <?= (validation_show_error('kondisi')) ? 'is-invalid' : '' ?>" id="kondisi" name="kondisi">
                                ...
                                <option value="Diperbaiki" <?= (old('kondisi') == 'Diperbaiki') ? 'selected' : '' ?>>Diperbaiki</date_format>
                            </select>
                             <div class="invalid-feedback">
