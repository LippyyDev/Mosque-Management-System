...
<div class="header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h2 class="page-title">Tambah Galeri Baru</h2>
...
<div class="card mt-4">
    ...
    <div class="card-body">
        <form action="<?= base_url('user/galeri/store') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control <?= (session('errors.tanggal')) ? 'is-invalid' : '' ?>" id="tanggal" name="tanggal" value="<?= old('tanggal') ?>">
                <div class="invalid-feedback">
                    <?= session('errors.tanggal') ?>
                </div>
            </div>
            <div class="mb-3">
                <label for="gambar" class="form-label">Gambar Galeri (bisa lebih dari satu)</label>
