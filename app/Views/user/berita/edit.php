...
<div class="card mt-4">
    <div class="card-header">
        <h5 class="card-title mb-0">Form Edit Berita</h5>
    </div>
    <div class="card-body">
        <form action="<?= base_url('user/berita/update/' . $berita['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="mb-3">
                <label for="judul" class="form-label">Judul</label>
                <input type="text" class="form-control <?= (session('errors.judul')) ? 'is-invalid' : '' ?>" id="judul" name="judul" value="<?= old('judul', $berita['judul']) ?>">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control <?= (session('errors.isi')) ? 'is-invalid' : '' ?>" id="isi" name="isi" rows="6"><?= old('isi', $berita['isi']) ?></textarea>
                <div class="invalid-feedback">
                    <?= session('errors.isi') ?>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control <?= (session('errors.tanggal_publish')) ? 'is-invalid' : '' ?>" id="tanggal_publish" name="tanggal_publish" value="<?= old('tanggal_publish', date('Y-m-d\TH:i', strtotime($berita['tanggal_publish']))) ?>">
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= (session('errors.lokasi')) ? 'is-invalid' : '' ?>" id="lokasi" name="lokasi" value="<?= old('lokasi', $berita['lokasi']) ?>">
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= (session('errors.video_youtube')) ? 'is-invalid' : '' ?>" id="video_youtube" name="video_youtube" value="<?= old('video_youtube', $berita['video_youtube']) ?>">
                <div class="invalid-feedback">
                    ...
                    <?php foreach ($gambar as $g): ?>
                        <div class="col-4 col-md-3">
                            <div class="position-relative border rounded bg-light p-1">
                                ...
                                <a href="#" data-hapus-url="<?= base_url('user/berita/delete-gambar/' . $g['id']) ?>" class="btn btn-sm btn-danger position-absolute top-0 end-0 m-1 btn-hapus-gambar" title="Hapus gambar">
